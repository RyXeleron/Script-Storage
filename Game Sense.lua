warn([[
GameSense Free | December 8, 2023
...
script.Name = 'GameSense Modified'
...
GUI.Name = 'GameSense Modified '..version
...
local Raccoon = Instance.new('TextLabel',GUI)
Raccoon.Name = 'GameSense Modified'
Raccoon.BackgroundTransparency = 1
Raccoon.Size = UDim2.new(0,500,0,50)
Raccoon.Position = UDim2.new(.5,-250,.85,-40)
Raccoon.TextSize = 24
Raccoon.Font = Enum.Font.SourceSansBold
Raccoon.TextColor3 = Color3.new(1,1,1)
Raccoon.TextStrokeColor3 = Color3.new(0,0,0)
Raccoon.TextStrokeTransparency = .6
Raccoon.Text = 'Join dsc.gg/rans today!'
Raccoon.ZIndex = 46
...
Credits.TextSize = 16
Credits.Text = 'GameSense Modified '..version..' by Ry!'
...
wait(.5)
Notification({Title='Main Coder';Text='Ry';Duration=4;Icon='https://www.roblox.com/Thumbs/Avatar.ashx?x=100&y=100&username=ImCherry511'})
wait(.5)
Notification({Title='Thank you!';Text='If you like this script, please leave a like on my Github!';Duration=4;})
