...
--[[
	...
	Lucky Blessed Administration By Ry © CC0 1.0 Universal (2023)
	...
	-- error("Nameless Admin is already running!", 0)
	return
end
...
if not game:IsLoaded() then
	...
	notLoaded.Text = 'Nameless Admin is waiting for the game to load'
	game.Loaded:Wait()
	notLoaded:Destroy()
end
...
wait(8)
 ...
 if FileSupport then
 if not isfolder('Ry') then
 makefolder('Ry')
 end
 
 if not isfolder('Ry/NA_Plugins') then
	 makefolder('Ry/NA_Plugins')
 end
 
 if not isfile("Ry/NA_Prefix.txt") then
 writefile("Ry/NA_Prefix.txt", ';')
 else
 end
 end
 ...
 local opt = {
	 prefix = readfile("Ry/NA_Prefix.txt", ';'), -- If player's executor has the custom file function support it reads the prefix file to get prefix
 ...
 cmd.add({"bypassproximity","bypassproxim","bypassproxy","bypassp","bypassprompt"}, {"bypassprompt <seconds>", "Bypass the proximity prompt."}, function(value)
	 game:GetService("ProximityPromptService").PromptButtonHoldBegan:Connect(function(prompt)
    prompt.HoldDuration = value
end)

    game.StarterGui:SetCore("ChatMakeSystemMessage", {
    Text = "Bypass Proximity Set!";
 ...
 Notify({
 Description = "Bypass Proximity Prompt: Enabled";
 Title = "Nameless Admin";
 Duration = 3;
 });

 Notify({
 Description = "Credits to Ry";
 Duration = 3;
 });
 end)
 ...
 writefile("Ry\\NA_Prefix.txt", PrefixChange)
 opt.prefix = PrefixChange
 Notify({
...
print(Time)
 ...
 cmd.add({"retrofly", "RetroFly"}, {"retrofly", "Retrofiy aims to accurately convert any Roblox game that the script is executed in to a late 2016 Roblox client, the exact client that is being simulated is a client from the 10th of December 2016."}, function()
 Notify({
	 Description = "Enabled RetroFly";
	 Title = "Nameless Admin";
	 Duration = 5;
	 });
 ...
 cmd.add({"2016roblox"}, {"ro2016", "Bring back ROBLOX's 2016 GUIs"}, function()
 Notify({
	 Description = "Enabled RO2016";
	 Title = "Nameless Admin";
	 Duration = 5;
	 });
 ...
 cmd.add({"2016robloxcompressed", "2016rc"}, {"ro2016rc", "Bring back ROBLOX's 2016 GUIs (Compressed version)"}, function()
 Notify({
	 Description = "Enabled RO2016 Compressed version";
	 Title = "Nameless Admin";
	 Duration = 5;
	 });
 ...
 loadstring(game:HttpGet("https://raw.githubusercontent.com/RyAtlasX/Script-Storages/main/2016rc",true))()
 end)
...
if b:IsA("Folder") then
 ...
 cmd.add({"admin"}, {"admin", "whitelist someone to allow them to use commands"}, function(...)
	 ...
	 if Player ~= nil and not Admin[Player.UserId] then
		 ...
		 ChatMessage("/w "..Player.Name.." [Nameless Admin] You've got admin permission. Prefix: ';'")
		 wait(0.2)
...
-- [[ THANKS TO LIGHTING BOLT FOR THIS ]] --
 ...
 cmd.add({"unfly"}, {"unfly", "Disable flight"}, function()
		 ...
		 Notify({
		 Description = "You're no longer flying.";
		 Title = "Nameless Admin";
		 Duration = 5;
...
game.Players.LocalPlayer.CameraMode = "LockFirstPerson"
 ...
 local success, result = pcall(function()
			 for i,v in pairs(listfiles("Ry/NA_Plugins")) do
			 loadstring(readfile(listfiles("Ry/NA_Plugins")[i]))();
