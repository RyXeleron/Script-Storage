--[[
CustomArray Ui Interface Suite
by Meta
...
local ArrayField = game:GetObjects("rbxassetid://11637506633")[1]
...
pcall(function()
_G.LastArrayField.Name = 'Old UI'
_G.LastArrayField.Enabled = false
end)
...
function ArrayFieldLibrary:CreateWindow(Settings)
	...
	LoadingFrame.Title.Text = Settings.LoadingTitle or "Lucky Blesser Interface Suite"
	LoadingFrame.Subtitle.Text = Settings.LoadingSubtitle or "by Ry | Atlas Xeleron"
	if Settings.LoadingTitle ~= "Lucky Blesser Interface Suite" then
		LoadingFrame.Version.Text = "Lucky Blessers' UI 🍀"
	end
	...
	pcall(function()
		...
		if not isfolder(ArrayFieldFolder.."/".."Configuration Folders") then
	...
	if Settings.KeySystem then
		...
		if Settings.KeySettings.GrabKeyFromSite then
			...
			if not Success then
				print("ArrayField | "..Settings.KeySettings.Key.." Error " ..tostring(Response))
			end
		end
